...
$(document).ready(function () {
  ...
  $(".product-meta__reviews-badge").on("click", function (e) {
    ...
    var element = document.getElementById("stamped-main-widget");
    var elementPosition = element.getBoundingClientRect().top;
    var offsetPosition = elementPosition - HEADER_HEIGHT;
  ...
  $(document).on('click','.pdp-stamped-main-badge-wrap', function(){
    $('.stamped-summary-actions-newreview').click();
  });
});
