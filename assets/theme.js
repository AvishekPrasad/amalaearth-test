        ...
        value: function _updateDiscountLabel(newVariant, previousVariant) {
          ...
          if (
            ...
            if (
              ...
              discountLabel.innerHTML = "(" + savings + ")";
            } else {
    ...
    _createClass(FeaturedCollectionSection, [
      ...
      },
      {
        ...
        value: function _addToCart(event, target) {
          ...
          var selectedElementValue = target.closest('form[action*="/cart/add"]').querySelector('.product-form__single-selector')?.value;
          if (selectedElementValue == 'NA') {
            return false;
          }
